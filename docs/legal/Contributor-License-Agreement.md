# Sovereign Contributor License Agreement (CLA)

_version 1.0 — 2025-11-06_
...
- **Core** means the Sovereign platform codebase (currently the repository root and the `platform/` directory).
- **Plugin** means a module intended to extend the Core via the plugin APIs.
...
1. under the AGPLv3, so the Contributions can be released as part of the Core; and
2. under any other license terms Maintainer selects, including proprietary or commercial licenses, to enable dual-licensing.
